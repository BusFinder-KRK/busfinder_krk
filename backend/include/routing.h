...
private:
    ...
    std::optional<std::pair<std::chrono::zoned_time<std::chrono::seconds>, std::string>>  dijkstra_dalekowzrocznosc(const std::string &start, const std::string &target, std::chrono::zoned_time<std::chrono::seconds> time);
